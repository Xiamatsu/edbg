...
#define OPTIONS_OPTR           0x1fff0080
#define OPTIONS_SDKR           0x1fff0084
#define OPTIONS_BOOT           0x1fff0088 // Only on PY32F002B
#define OPTIONS_WRPR           0x1fff008c
...
{
  { 0x20220064, "py32f002b", "PY32F002Bx5", 24*1024 },
};
...
//-----------------------------------------------------------------------------
target_ops_t target_puya_py32f002b_ops =
{
